...
class BarcodeProductLookup {
  ...
  static Future<BarcodeLookupResult> resolveDetailed({
    ...
    try {
      ...
      if (direct != null && direct.matchesBarcode(q)) {
        return BarcodeLookupResult(product: direct);
      }
      final picked = SalesProducts.pickAutoAddBarcode(res, allowSingleResult: true);
      if (picked != null && picked.matchesBarcode(q)) {
        return BarcodeLookupResult(product: picked);
      }
    ...
    try {
      ...
      if (fromProductsApi != null) {
        return BarcodeLookupResult(product: fromProductsApi);
      }
    } catch (_) {}
